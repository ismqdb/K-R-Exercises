I've learned C (and programming basics) from the K&R book. This repo is a collection of my solutions to exercises from it, minus the last chapter, which is more concerned with Unix.
